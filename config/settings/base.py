...
LOCAL_APPS = [
    ...
    'nomadgram.notifications.apps.NotificationsConfig'  # notifications apps
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://wonil:dnjsdlf24@localhost:32769/nomadgram'),
}
